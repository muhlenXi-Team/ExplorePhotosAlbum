...
class FxPhotoAlbumView: UIView {
    ...
    fileprivate func addPhotoViewsByCount(count: Int) {
        for i in 0..<count {
    ...
    fileprivate func getPhotoViewWithTag(tag: Int) -> FxPhotoView? {
...
extension FxPhotoAlbumView {
    ...
    fileprivate func addConstraintToFourPhotos_normal() {
        addConstraintToThreePhotos()
    ...
    fileprivate func addConstraintToFivePhotos() {
        addConstraintToThreePhotos()
        let photo3 = getPhotoViewWithTag(tag: tagBase+3)!
        photo3.snp.makeConstraints({ (make) in
            make.top.equalTo(topSpace+imageWidth+imageSpace)
    ...
    fileprivate func addConstraintToSixPhotos() {
        addConstraintToThreePhotos()
        let photo3 = getPhotoViewWithTag(tag: tagBase+3)!
        photo3.snp.makeConstraints({ (make) in
            make.top.equalTo(topSpace+imageWidth+imageSpace)
    ...
    fileprivate func addConstraintToEightPhotos() {
        addConstraintToSixPhotos()
        let photo6 = getPhotoViewWithTag(tag: tagBase+6)!
        photo6.snp.makeConstraints({ (make) in
            make.top.equalTo(topSpace+(imageWidth+imageSpace)*2)
    ...
    fileprivate func addConstraintToNinePhotos() {
        addConstraintToSixPhotos()
        let photo6 = getPhotoViewWithTag(tag: tagBase+6)!
        photo6.snp.makeConstraints({ (make) in
            make.top.equalTo(topSpace+(imageWidth+imageSpace)*2)
    ...
    fileprivate func removeAllPhotosContraint() {
        for i in 0..<9 {
    ...
    fileprivate func removeAllPhotoViews() {
        for i in 0..<9 {
            if let photo = getPhotoViewWithTag(tag: tagBase+i) {
    ...
    fileprivate func setAllPhotosImageToNil() {
        for i in 0..<9 {
            if let photo = getPhotoViewWithTag(tag: tagBase+i) {
